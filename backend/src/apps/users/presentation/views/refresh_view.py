...
from ...domain.exceptions import InvalidTokenException, SessionRevokedException, ExpiredTokenException
...
class RefreshView(APIView):
    ...
    @extend_schema(
        ...
        responses={
            200: RefreshResponseSerializers,
    ...
    def post(self, request):
        ...
        try: 
            result = use_case.execute(refresh_token=serializer.validated_data["refresh_token"],)
