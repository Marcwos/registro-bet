...
from ...domain.exceptions import InvalidTokenException, ExpiredTokenException
...
class LogoutView(APIView):
    ...
    def post(self, request):
        ...
        use_case = LogoutUser(session_repository=DjandoAuthSessionRepository(), token_provider=JwtTokenProvider(),)
        
        try:
            use_case.execute(refresh_token=serializer.validated_data["refresh_token"],)
